var metaplex = (function (exports, require$$1, require$$1$1) {
  ...
  ***************************************************************************** */
  ...
  const getFileHash = (file) => __awaiter$c(void 0, void 0, void 0, function* () { return buffer.Buffer.from(yield sha256(file.toString())); });
  ...
  const lookup = (url) => __awaiter$c(void 0, void 0, void 0, function* () {
      try {
  ...
  class Account {
      constructor(pubkey, info) {
          this.pubkey = new web3_js_1$L.PublicKey(pubkey);
          this.info = info;
      }
      static from(account) {
      ...
      static getInfo(connection, pubkey) {
          return __awaiter$b(this, void 0, void 0, function* () {
              const info = yield connection.getAccountInfo(new web3_js_1$L.PublicKey(pubkey));
              if (!info) {
                  throw (0, errors_1.ERROR_ACCOUNT_NOT_FOUND)(pubkey);
              }
              return Object.assign(Object.assign({}, info), { data: buffer_1$e.Buffer.from(info === null || info === void 0 ? void 0 : info.data) });
          });
      }
      ...
      static getMultipleAccounts(connection, pubkeys, commitment) {
          return __awaiter$b(this, void 0, void 0, function* () {
              ...
              const infos = unsafeRes.result.value
                  .filter(Boolean)
                  .map((info) => (Object.assign(Object.assign({}, info), { data: buffer_1$e.Buffer.from(info.data[0], 'base64') })));
      ...
      assertOwner(pubkey) {
          var _a;
          return (_a = this.info) === null || _a === void 0 ? void 0 : _a.owner.equals(new web3_js_1$L.PublicKey(pubkey));
      }
      toJSON() {
          var _a, _b, _c, _d, _e;
          return {
              ...
              info: {
                  ...
                  owner: ((_b = this.info) === null || _b === void 0 ? void 0 : _b.owner) ? new web3_js_1$L.PublicKey((_c = this.info) === null || _c === void 0 ? void 0 : _c.owner) : null,
  ...
  class Program {
      static findProgramAddress(seeds) {
          return __awaiter$a(this, void 0, void 0, function* () {
              return (yield web3_js_1$K.PublicKey.findProgramAddress(seeds, this.PUBKEY))[0];
          });
      }
      static getProgramAccounts(connection, configOrCommitment) {
          return __awaiter$a(this, void 0, void 0, function* () {
              ...
              return unsafeRes.result
                  ...
                  account: {
                      data: buffer_1$d.Buffer.from(data[0], 'base64'),
                      executable,
                      lamports,
                      owner: new web3_js_1$K.PublicKey(owner),
                  },
                  pubkey: new web3_js_1$K.PublicKey(pubkey),
              }))
  ...
  class Transaction extends web3_js_1$J.Transaction {
      constructor(options) {
          super(options);
      }
  ...
  const bn_js_1$3 = __importDefault$6(bn.exports);
  ...
  function baseEncode(value) {
      ...
      return bs58_1$3.default.encode(Buffer.from(value));
  }
  lib.baseEncode = baseEncode;
  function baseDecode(value) {
      return Buffer.from(bs58_1$3.default.decode(value));
  }
  ...
  class SafetyDepositBoxData extends mpl_core_1$J.Borsh.Data {
      constructor(args) {
          super(args);
  ...
  class SafetyDepositBox extends mpl_core_1$J.Account {
      ...
      static getPDA(vault, mint) {
          return __awaiter$9(this, void 0, void 0, function* () {
              return VaultProgram_1$c.VaultProgram.findProgramAddress([
                  buffer_1$c.Buffer.from(VaultProgram_1$c.VaultProgram.PREFIX),
                  new web3_js_1$I.PublicKey(vault).toBuffer(),
                  new web3_js_1$I.PublicKey(mint).toBuffer(),
              ]);
          });
      }
      static isCompatible(data) {
  ...
  class ExternalPriceAccountData extends mpl_core_1$I.Borsh.Data {
      constructor(args) {
          super(args);
  ...
  class ExternalPriceAccount extends mpl_core_1$I.Account {
      constructor(key, info) {
          super(key, info);
          if (!this.assertOwner(VaultProgram_1$b.VaultProgram.PUBKEY)) {
              throw (0, mpl_core_1$I.ERROR_INVALID_OWNER)();
          }
          if (!ExternalPriceAccount.isCompatible(this.info.data)) {
              throw (0, mpl_core_1$I.ERROR_INVALID_ACCOUNT_DATA)();
          }
  ...
  class ActivateVault extends mpl_core_1$H.Transaction {
  ...
  class AddSharesToTreasury extends mpl_core_1$G.Transaction {
      constructor(options, params) {
          super(options);
  ...
  class AddTokenToInactiveVault extends mpl_core_1$F.Transaction {
      constructor(options, params) {
          super(options);
  ...
  class CombineVaultArgs extends mpl_core_1$E.Borsh.Data {
      constructor() {
          super(...arguments);
  ...
  class CombineVault extends mpl_core_1$E.Transaction {
      constructor(options, params) {
          super(options);
  ...
  class InitVaultArgs extends mpl_core_1$D.Borsh.Data {
      constructor() {
          super(...arguments);
  ...
  class InitVault extends mpl_core_1$D.Transaction {
      constructor(options, params) {
          super(options);
          ...
          this.add(new web3_js_1$D.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$D.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  class MintFractionalShares extends mpl_core_1$C.Transaction {
      constructor(options, params) {
          super(options);
          const { vault, vaultAuthority, fractionMint, fractionTreasury, fractionMintAuthority, numberOfShares, } = params;
          ...
          this.add(new web3_js_1$C.TransactionInstruction({
              keys: [
                  {
                      pubkey: fractionTreasury,
                      isSigner: false,
  ...
  class RedeemSharesArgs extends mpl_core_1$B.Borsh.Data {
      constructor() {
          super(...arguments);
  ...
  class RedeemShares extends mpl_core_1$B.Transaction {
      constructor(options, params) {
          super(options);
          ...
          this.add(new web3_js_1$B.TransactionInstruction({
              keys: [
                  {
                  ...
                  {
                      pubkey: web3_js_1$B.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  class SetVaultAuthorityArgs extends mpl_core_1$A.Borsh.Data {
      constructor() {
          super(...arguments);
  ...
  class SetVaultAuthority extends mpl_core_1$A.Transaction {
      constructor(options, params) {
          super(options);
          const { vault, currentAuthority, newAuthority } = params;
          const data = SetVaultAuthorityArgs.serialize();
          this.add(new web3_js_1$A.TransactionInstruction({
              keys: [
                  {
                      pubkey: vault,
                      isSigner: false,
  ...
  class UpdateExternalPriceAccountArgs extends mpl_core_1$z.Borsh.Data {
      constructor() {
          super(...arguments);
  ...
  class UpdateExternalPriceAccount extends mpl_core_1$z.Transaction {
      constructor(options, params) {
          super(options);
          ...
          this.add(new web3_js_1$z.TransactionInstruction({
              keys: [
                  {
                      pubkey: externalPriceAccount,
                      isSigner: false,
  ...
  class WithdrawSharesFromTreasury extends mpl_core_1$y.Transaction {
      constructor(options, params) {
          super(options);
          ...
          this.add(new web3_js_1$y.TransactionInstruction({
              keys: [
                  {
                      pubkey: destination,
                      isSigner: false,
                  ...
                  {
                      pubkey: web3_js_1$y.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  class WithdrawTokenFromSafetyDepositBox extends mpl_core_1$x.Transaction {
      constructor(options, params) {
          super(options);
          ...
          this.add(new web3_js_1$x.TransactionInstruction({
              keys: [
                  {
                      pubkey: destination,
                      isSigner: false,
                  ...
                  {
                      pubkey: web3_js_1$x.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  const sendTransaction = ({ connection, wallet, txs, signers = [], options, }) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const addTokensToVault = ({ connection, wallet, vault, nfts, }) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  class AuctionProgram extends mpl_core_1$w.Program {
  }
  AuctionProgram$1.AuctionProgram = AuctionProgram;
  AuctionProgram.PREFIX = 'auction';
  AuctionProgram.EXTENDED = 'extended';
  AuctionProgram.PUBKEY = new web3_js_1$w.PublicKey(mpl_core_1$w.config.programs.auction);
  ...
  class BidderMetadataData extends mpl_core_1$v.Borsh.Data {
  }
  ...
  class BidderMetadata extends mpl_core_1$v.Account {
      constructor(key, info) {
          super(key, info);
      ...
      static getPDA(auction, bidder) {
          return AuctionProgram_1$6.AuctionProgram.findProgramAddress([
              buffer_1$b.Buffer.from(AuctionProgram_1$6.AuctionProgram.PREFIX),
              AuctionProgram_1$6.AuctionProgram.PUBKEY.toBuffer(),
              new web3_js_1$v.PublicKey(auction).toBuffer(),
              new web3_js_1$v.PublicKey(bidder).toBuffer(),
              buffer_1$b.Buffer.from('metadata'),
          ]);
      }
  }
  ...
  class BidderPotData extends mpl_core_1$u.Borsh.Data {
  }
  ...
  class BidderPot extends mpl_core_1$u.Account {
      constructor(key, info) {
          super(key, info);
      ...
      static getPDA(auction, bidder) {
          return AuctionProgram_1$5.AuctionProgram.findProgramAddress([
              buffer_1$a.Buffer.from(AuctionProgram_1$5.AuctionProgram.PREFIX),
              AuctionProgram_1$5.AuctionProgram.PUBKEY.toBuffer(),
              new web3_js_1$u.PublicKey(auction).toBuffer(),
              new web3_js_1$u.PublicKey(bidder).toBuffer(),
          ]);
      }
  }
  ...
  class AuctionDataExtended extends mpl_core_1$t.Borsh.Data {
  }
  ...
  class AuctionExtended extends mpl_core_1$t.Account {
      constructor(pubkey, info) {
          super(pubkey, info);
      ...
      static getPDA(vault) {
          return AuctionProgram_1$4.AuctionProgram.findProgramAddress([
              buffer_1$9.Buffer.from(AuctionProgram_1$4.AuctionProgram.PREFIX),
              AuctionProgram_1$4.AuctionProgram.PUBKEY.toBuffer(),
              new web3_js_1$t.PublicKey(vault).toBuffer(),
              buffer_1$9.Buffer.from(AuctionProgram_1$4.AuctionProgram.EXTENDED),
          ]);
      }
  }
  ...
  class CancelBidArgs extends mpl_core_1$s.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 0;
      }
  ...
  class CancelBid extends mpl_core_1$s.Transaction {
      constructor(options, params) {
          super(options);
          ...
          this.add(new web3_js_1$s.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$s.SYSVAR_CLOCK_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
                      pubkey: web3_js_1$s.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
                      pubkey: web3_js_1$s.SystemProgram.programId,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
  ...
  class CreateAuctionV2Args extends mpl_core_1$r.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 7;
      }
  ...
  class CreateAuctionV2 extends mpl_core_1$r.Transaction {
      constructor(options, params) {
          super(options);
          const { args, auction, auctionExtended, creator } = params;
          ...
          this.add(new web3_js_1$r.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$r.SystemProgram.programId,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  class PlaceBidArgs extends mpl_core_1$q.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 6;
      }
  ...
  class PlaceBid extends mpl_core_1$q.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
          ...
          this.add(new web3_js_1$q.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$q.SYSVAR_CLOCK_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
  ...
  const AuctionProgram_1 = AuctionProgram$1;
  class SetAuctionAuthorityArgs extends mpl_core_1$p.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 5;
      }
  ...
  class SetAuctionAuthority extends mpl_core_1$p.Transaction {
      constructor(options, params) {
          super(options);
  ...
  class PayoutTicketData extends mpl_core_1$o.Borsh.Data {
      constructor(args) {
          super(args);
  ...
  class PayoutTicket extends mpl_core_1$o.Account {
      constructor(pubkey, info) {
          super(pubkey, info);
          if (!this.assertOwner(MetaplexProgram_1$f.MetaplexProgram.PUBKEY)) {
              throw (0, mpl_core_1$o.ERROR_INVALID_OWNER)();
          }
          if (!PayoutTicket.isCompatible(this.info.data)) {
              throw (0, mpl_core_1$o.ERROR_INVALID_ACCOUNT_DATA)();
          }
                  ...
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58_1$2.default.encode(buffer_1$8.Buffer.from([MetaplexProgram_1$f.MetaplexKey.PayoutTicketV1])),
                          },
                      },
                      {
                          memcmp: {
                              offset: 1,
                              bytes: new web3_js_1$o.PublicKey(recipient).toBase58(),
                          },
                      },
                  ],
  ...
  class PrizeTrackingTicketData extends mpl_core_1$n.Borsh.Data {
      constructor(args) {
          super(args);
  ...
  class PrizeTrackingTicket extends mpl_core_1$n.Account {
      constructor(pubkey, info) {
          super(pubkey, info);
          if (!this.assertOwner(MetaplexProgram_1$e.MetaplexProgram.PUBKEY)) {
              throw (0, mpl_core_1$n.ERROR_INVALID_OWNER)();
          }
          if (!PrizeTrackingTicket.isCompatible(this.info.data)) {
              throw (0, mpl_core_1$n.ERROR_INVALID_ACCOUNT_DATA)();
          }
      ...
      static getPDA(auctionManager, mint) {
          return __awaiter$7(this, void 0, void 0, function* () {
              return MetaplexProgram_1$e.MetaplexProgram.findProgramAddress([
                  buffer_1$7.Buffer.from(MetaplexProgram_1$e.MetaplexProgram.PREFIX),
                  MetaplexProgram_1$e.MetaplexProgram.PUBKEY.toBuffer(),
                  new web3_js_1$n.PublicKey(auctionManager).toBuffer(),
                  new web3_js_1$n.PublicKey(mint).toBuffer(),
              ]);
          });
      }
  }
  ...
  class WhitelistedCreatorData extends mpl_core_1$m.Borsh.Data {
      constructor(args) {
          super(args);
  ...
  class WhitelistedCreator extends mpl_core_1$m.Account {
      constructor(pubkey, info) {
          super(pubkey, info);
          if (!this.assertOwner(MetaplexProgram_1$d.MetaplexProgram.PUBKEY)) {
              throw (0, mpl_core_1$m.ERROR_INVALID_OWNER)();
          }
          if (!WhitelistedCreator.isCompatible(this.info.data)) {
              throw (0, mpl_core_1$m.ERROR_INVALID_ACCOUNT_DATA)();
          }
      ...
      static getPDA(store, creator) {
          return __awaiter$6(this, void 0, void 0, function* () {
              return MetaplexProgram_1$d.MetaplexProgram.findProgramAddress([
                  buffer_1$6.Buffer.from(MetaplexProgram_1$d.MetaplexProgram.PREFIX),
                  MetaplexProgram_1$d.MetaplexProgram.PUBKEY.toBuffer(),
                  new web3_js_1$m.PublicKey(store).toBuffer(),
                  new web3_js_1$m.PublicKey(creator).toBuffer(),
              ]);
          });
      }
  }
  ...
  class Store extends mpl_core_1$l.Account {
      constructor(pubkey, info) {
          super(pubkey, info);
      ...
      static getPDA(owner) {
          return __awaiter$5(this, void 0, void 0, function* () {
              return MetaplexProgram_1$c.MetaplexProgram.findProgramAddress([
                  buffer_1$5.Buffer.from(MetaplexProgram_1$c.MetaplexProgram.PREFIX),
                  MetaplexProgram_1$c.MetaplexProgram.PUBKEY.toBuffer(),
                  new web3_js_1$l.PublicKey(owner).toBuffer(),
              ]);
          });
      }
                  ...
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58_1$1.default.encode(buffer_1$5.Buffer.from([MetaplexProgram_1$c.MetaplexKey.WhitelistedCreatorV1])),
                          },
                      },
                  ],
                  ...
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58_1$1.default.encode(buffer_1$5.Buffer.from([MetaplexProgram_1$c.MetaplexKey.AuctionManagerV2])),
                          },
                      },
                      {
                          memcmp: {
  ...
  class StoreConfigData extends mpl_core_1$k.Borsh.Data {
      constructor(args) {
          super(args);
  ...
  class StoreConfig extends mpl_core_1$k.Account {
      constructor(pubkey, info) {
          super(pubkey, info);
      ...
      static getPDA(store) {
          return __awaiter$4(this, void 0, void 0, function* () {
              return MetaplexProgram_1$b.MetaplexProgram.findProgramAddress([
                  buffer_1$4.Buffer.from(MetaplexProgram_1$b.MetaplexProgram.PREFIX),
                  MetaplexProgram_1$b.MetaplexProgram.PUBKEY.toBuffer(),
                  buffer_1$4.Buffer.from(MetaplexProgram_1$b.MetaplexProgram.CONFIG),
                  new web3_js_1$k.PublicKey(store).toBuffer(),
              ]);
          });
      }
  }
  ...
  const mpl_core_1$j = mplCore$2;
  const web3_js_1$j = require$$1__default["default"];
  const bn_js_1$2 = __importDefault$3(bn.exports);
  const buffer_1$3 = buffer;
  const MetaplexProgram_1$a = MetaplexProgram;
  class AuctionWinnerTokenTypeTracker extends mpl_core_1$j.Account {
      constructor(pubkey, info) {
          super(pubkey, info);
      ...
      static getPDA(auctionManager) {
          return __awaiter$3(this, void 0, void 0, function* () {
              return MetaplexProgram_1$a.MetaplexProgram.findProgramAddress([
                  buffer_1$3.Buffer.from(MetaplexProgram_1$a.MetaplexProgram.PREFIX),
                  MetaplexProgram_1$a.MetaplexProgram.PUBKEY.toBuffer(),
                  new web3_js_1$j.PublicKey(auctionManager).toBuffer(),
                  buffer_1$3.Buffer.from(MetaplexProgram_1$a.MetaplexProgram.TOTALS),
              ]);
          });
      }
  }
  ...
  const deserialize = (buffer) => {
      ...
      let offset = 7;
      for (let i = 0; i < lengthOfArray.toNumber(); i++) {
          const amount = (0, mpl_core_1$j.getBNFromData)(buffer, offset, data.amountType);
          offset += data.amountType;
          const length = (0, mpl_core_1$j.getBNFromData)(buffer, offset, data.lengthType);
          offset += data.lengthType;
          data.amountRanges.push({ amount, length });
      }
      return data;
  ...
  class ClaimBidArgs extends mpl_core_1$i.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 6;
      }
  ...
  class ClaimBid extends mpl_core_1$i.Transaction {
      constructor(options, params) {
          super(options);
          ...
          this.add(new web3_js_1$i.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$i.SYSVAR_CLOCK_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
  ...
  const bn_js_1$1 = __importDefault$2(bn.exports);
  const mpl_core_1$h = mplCore$2;
  const web3_js_1$h = require$$1__default["default"];
  const mpl_auction_1$3 = mplAuction$2;
  const MetaplexProgram_1$8 = MetaplexProgram;
  class EndAuctionArgs extends mpl_core_1$h.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 20;
      }
  ...
  class EndAuction extends mpl_core_1$h.Transaction {
      constructor(options, params) {
          super(options);
          ...
          this.add(new web3_js_1$h.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$h.SYSVAR_CLOCK_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  class InitAuctionManagerV2Args extends mpl_core_1$g.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 17;
          this.amountType = mpl_core_1$g.TupleNumericType.U8;
          this.lengthType = mpl_core_1$g.TupleNumericType.U8;
  ...
  class InitAuctionManagerV2 extends mpl_core_1$g.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
  ...
  const mpl_core_1$f = mplCore$2;
  const MetadataProgram_1$8 = MetadataProgram;
  const web3_js_1$f = require$$1__default["default"];
  const buffer_1$2 = buffer;
  class EditionData extends mpl_core_1$f.Borsh.Data {
      constructor(args) {
          super(args);
          this.key = MetadataProgram_1$8.MetadataKey.EditionV1;
      }
  }
  ...
  class Edition extends mpl_core_1$f.Account {
      constructor(key, info) {
          super(key, info);
          if (!this.assertOwner(MetadataProgram_1$8.MetadataProgram.PUBKEY)) {
              throw (0, mpl_core_1$f.ERROR_INVALID_OWNER)();
          }
          if (!Edition.isCompatible(this.info.data)) {
              throw (0, mpl_core_1$f.ERROR_INVALID_ACCOUNT_DATA)();
          }
          this.data = EditionData.deserialize(this.info.data);
      }
      static getPDA(mint) {
          return __awaiter$2(this, void 0, void 0, function* () {
              return MetadataProgram_1$8.MetadataProgram.findProgramAddress([
                  buffer_1$2.Buffer.from(MetadataProgram_1$8.MetadataProgram.PREFIX),
                  MetadataProgram_1$8.MetadataProgram.PUBKEY.toBuffer(),
                  new web3_js_1$f.PublicKey(mint).toBuffer(),
                  buffer_1$2.Buffer.from(Edition.EDITION_PREFIX),
              ]);
          });
      }
      static isCompatible(data) {
          return data[0] === MetadataProgram_1$8.MetadataKey.EditionV1;
      }
  }
  ...
  const MetadataProgram_1$7 = MetadataProgram;
  const buffer_1$1 = buffer;
  class EditionMarkerData extends mpl_core_1$e.Borsh.Data {
      constructor(args) {
          super(args);
          this.key = MetadataProgram_1$7.MetadataKey.EditionMarker;
      }
  ...
  class EditionMarker extends mpl_core_1$e.Account {
      constructor(key, info) {
          super(key, info);
          if (!this.assertOwner(MetadataProgram_1$7.MetadataProgram.PUBKEY)) {
      ...
      static getPDA(mint, edition) {
          return __awaiter$1(this, void 0, void 0, function* () {
              ...
              return MetadataProgram_1$7.MetadataProgram.findProgramAddress([
                  buffer_1$1.Buffer.from(MetadataProgram_1$7.MetadataProgram.PREFIX),
                  MetadataProgram_1$7.MetadataProgram.PUBKEY.toBuffer(),
                  new web3_js_1$e.PublicKey(mint).toBuffer(),
                  buffer_1$1.Buffer.from(Edition_1$1.Edition.EDITION_PREFIX),
                  buffer_1$1.Buffer.from(editionNumber.toString()),
              ]);
          });
      }
      static isCompatible(data) {
          return data[0] === MetadataProgram_1$7.MetadataKey.EditionMarker;
      }
  }
  ...
  const MetadataProgram_1$6 = MetadataProgram;
  const buffer_1 = buffer;
  const web3_js_1$d = require$$1__default["default"];
  class MasterEditionV1Data extends mpl_core_1$d.Borsh.Data {
      constructor(args) {
          super(args);
          this.key = MetadataProgram_1$6.MetadataKey.MasterEditionV1;
      }
  }
  ...
  class MasterEditionV2Data extends mpl_core_1$d.Borsh.Data {
      constructor(args) {
          super(args);
          this.key = MetadataProgram_1$6.MetadataKey.MasterEditionV2;
      }
  }
  ...
  class MasterEdition extends mpl_core_1$d.Account {
      constructor(key, info) {
          super(key, info);
          if (!this.assertOwner(MetadataProgram_1$6.MetadataProgram.PUBKEY)) {
      ...
      static getPDA(mint) {
          return __awaiter(this, void 0, void 0, function* () {
              return MetadataProgram_1$6.MetadataProgram.findProgramAddress([
                  buffer_1.Buffer.from(MetadataProgram_1$6.MetadataProgram.PREFIX),
                  MetadataProgram_1$6.MetadataProgram.PUBKEY.toBuffer(),
                  new web3_js_1$d.PublicKey(mint).toBuffer(),
      ...
      static isMasterEditionV1(data) {
          return data[0] === MetadataProgram_1$6.MetadataKey.MasterEditionV1;
      }
      static isMasterEditionV2(data) {
          return data[0] === MetadataProgram_1$6.MetadataKey.MasterEditionV2;
      }
      getEditions(connection) {
          return __awaiter(this, void 0, void 0, function* () {
              return (yield MetadataProgram_1$6.MetadataProgram.getProgramAccounts(connection, {
                  filters: [
                      {
                          memcmp: {
                              offset: 0,
                              bytes: bs58_1.default.encode(buffer_1.Buffer.from([MetadataProgram_1$6.MetadataKey.EditionV1])),
                          },
                      },
                      {
                          memcmp: {
  ...
  const bs58_1 = __importDefault(bs58);
  const buffer_1 = buffer;
  const MetadataProgram_1 = MetadataProgram;
  const Edition_1 = Edition$1;
  ...
  const MetadataProgram_1$5 = MetadataProgram;
  class CreateMetadataArgs extends mpl_core_1$c.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 0;
      }
  ...
  CreateMetadataArgs.SCHEMA = new Map([
      ...Metadata_1$1.MetadataDataData.SCHEMA,
      ...CreateMetadataArgs.struct([
          ['instruction', 'u8'],
          ['data', Metadata_1$1.MetadataDataData],
          ['isMutable', 'u8'],
      ]),
  ]);
  class CreateMetadata extends mpl_core_1$c.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
          ...
          this.add(new web3_js_1$c.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$c.SystemProgram.programId,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
                      pubkey: web3_js_1$c.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  const MetadataProgram_1$4 = MetadataProgram;
  class UpdateMetadataArgs extends mpl_core_1$b.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 1;
      }
  ...
  class UpdateMetadata extends mpl_core_1$b.Transaction {
      constructor(options, params) {
          super(options);
  ...
  const web3_js_1$a = require$$1__default["default"];
  const MetadataProgram_1$3 = MetadataProgram;
  class CreateMasterEditionArgs extends mpl_core_1$a.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 10;
      }
  ...
  class CreateMasterEdition extends mpl_core_1$a.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
          ...
          this.add(new web3_js_1$a.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$a.SystemProgram.programId,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
                      pubkey: web3_js_1$a.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  const MetadataProgram_1$2 = MetadataProgram;
  class MintNewEditionFromMasterEditionViaTokenArgs extends mpl_core_1$9.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 11;
      }
  ...
  class MintNewEditionFromMasterEditionViaToken extends mpl_core_1$9.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
          ...
          this.add(new web3_js_1$9.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: spl_token_1$5.TOKEN_PROGRAM_ID,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
  ...
  const MetadataProgram_1$1 = MetadataProgram;
  class UpdatePrimarySaleHappenedViaTokenArgs extends mpl_core_1$8.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 4;
      }
  ...
  class UpdatePrimarySaleHappenedViaToken extends mpl_core_1$8.Transaction {
      constructor(options, params) {
          super(options);
  ...
  const MetadataProgram_1 = MetadataProgram;
  class SignMetadataArgs extends mpl_core_1$7.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 7;
      }
  ...
  class SignMetadata extends mpl_core_1$7.Transaction {
      constructor(options, params) {
          super(options);
  ...
  __exportStar(MetadataProgram, exports);
  ...
  const spl_token_1 = require$$1__default$1["default"];
  const web3_js_1 = require$$1__default["default"];
  const mpl_token_metadata_1 = mplTokenMetadata$2;
  ...
  const mpl_token_metadata_1$4 = mplTokenMetadata$2;
  const mpl_token_vault_1$4 = mplTokenVault$2;
  const MetaplexProgram_1$6 = MetaplexProgram;
  const RedeemBid_1 = RedeemBid;
  class RedeemFullRightsTransferBidArgs extends mpl_core_1$6.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 3;
      }
  ...
  class RedeemFullRightsTransferBid extends mpl_core_1$6.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
          ...
          this.add(new web3_js_1$6.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: spl_token_1$4.TOKEN_PROGRAM_ID,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
  ...
  const mpl_token_metadata_1$3 = mplTokenMetadata$2;
  ...
  class RedeemPrintingV2BidArgs extends mpl_core_1$5.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 14;
      }
  ...
  class RedeemPrintingV2Bid extends mpl_core_1$5.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
          ...
          this.add(new web3_js_1$5.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$5.SystemProgram.programId,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
                      pubkey: web3_js_1$5.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
  ...
  class SetStore extends mpl_core_1$4.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
          ...
          this.add(new web3_js_1$4.TransactionInstruction({
              keys: [
                  ...
                  { pubkey: spl_token_1$2.TOKEN_PROGRAM_ID, isSigner: false, isWritable: false },
                  {
                  ...
                  {
                      pubkey: web3_js_1$4.SystemProgram.programId,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
                      pubkey: web3_js_1$4.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  const mpl_token_metadata_1$1 = mplTokenMetadata$2;
  const mpl_auction_1$1 = mplAuction$2;
  const MetaplexProgram_1$3 = MetaplexProgram;
  class SetStoreV2Args extends mpl_core_1$3.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 23;
      }
  ...
  class SetStoreV2 extends mpl_core_1$3.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
          ...
          this.add(new web3_js_1$3.TransactionInstruction({
              keys: [
                  ...
                  { pubkey: spl_token_1$1.TOKEN_PROGRAM_ID, isSigner: false, isWritable: false },
                  {
                  ...
                  {
                      pubkey: web3_js_1$3.SystemProgram.programId,
                      isSigner: false,
                      isWritable: false,
                  },
                  {
                      pubkey: web3_js_1$3.SYSVAR_RENT_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  class SetWhitelistedCreatorArgs extends mpl_core_1$2.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 9;
      }
  ...
  class SetWhitelistedCreator extends mpl_core_1$2.Transaction {
      constructor(options, params) {
          super(options);
          const { feePayer } = options;
  ...
  class StartAuctionArgs extends mpl_core_1$1.Borsh.Data {
      constructor() {
          super(...arguments);
          this.instruction = 5;
      }
  ...
  class StartAuction extends mpl_core_1$1.Transaction {
      constructor(options, params) {
          super(options);
          ...
          this.add(new web3_js_1$1.TransactionInstruction({
              keys: [
                  ...
                  {
                      pubkey: web3_js_1$1.SYSVAR_CLOCK_PUBKEY,
                      isSigner: false,
                      isWritable: false,
                  },
              ],
  ...
  const initStore = ({ connection, wallet, isPublic = true, }) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const initStoreV2 = ({ connection, wallet, settingsUri = null, isPublic = true, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const storeId = yield mplMetaplex$2.Store.getPDA(wallet.publicKey);
  ...
  const mintNFT = ({ connection, wallet, uri, maxSupply, }) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const mintEditionFromMaster = ({ connection, wallet, masterEditionMint, updateAuthority } = {}) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const createMetadata = ({ connection, wallet, editionMint, metadataData, updateAuthority } = {}) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const createMasterEdition = ({ connection, wallet, editionMint, updateAuthority, maxSupply } = {}) => __awaiter$c(void 0, void 0, void 0, function* () {
      const metadata = yield mplTokenMetadata$2.Metadata.getPDA(editionMint);
  ...
  const signMetadata = ({ connection, wallet, editionMint, signer } = {}) => __awaiter$c(void 0, void 0, void 0, function* () {
      const metadata = yield mplTokenMetadata$2.Metadata.getPDA(editionMint);
  ...
  const updateMetadata = ({ connection, wallet, editionMint, newMetadataData, newUpdateAuthority, primarySaleHappened, } = {}) => __awaiter$c(void 0, void 0, void 0, function* () {
      const metadata = yield mplTokenMetadata$2.Metadata.getPDA(editionMint);
  ...
  const cancelBid = ({ connection, wallet, auction, bidderPotToken, destAccount, }) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const getCancelBidTransactions = ({ destAccount, bidder, accountRentExempt, bidderPot, bidderPotToken, bidderMeta, auction, auctionExtended, auctionTokenMint, vault, }) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const placeBid = ({ connection, wallet, amount, auction, bidderPotToken, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const bidder = wallet.publicKey;
      const accountRentExempt = yield connection.getMinimumBalanceForRentExemption(require$$1$1.AccountLayout.span);
      const auctionManager = yield mplMetaplex$2.AuctionManager.getPDA(auction);
      const manager = yield mplMetaplex$2.AuctionManager.load(connection, auctionManager);
  ...
  const redeemFullRightsTransferBid = ({ connection, wallet, store, auction, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const bidder = wallet.publicKey;
      const accountRentExempt = yield connection.getMinimumBalanceForRentExemption(require$$1$1.AccountLayout.span);
      const auctionManager = yield mplMetaplex$2.AuctionManager.getPDA(auction);
      const manager = yield mplMetaplex$2.AuctionManager.load(connection, auctionManager);
  ...
  const getRedeemFRTBidTransactions = ({ accountRentExempt, bidder, tokenMint, store, vault, auction, auctionManager, auctionExtended, bidRedemption, bidderMeta: bidMetadata, safetyDepositTokenStore, safetyDeposit, fractionMint, safetyDepositConfig, transferAuthority, metadata, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const txBatch = new TransactionsBatch({ transactions: [] });
      const account = require$$1.Keypair.generate();
  ...
  const getBidRedemptionPDA = (auction, bidderMeta) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const redeemPrintingV2Bid = ({ connection, wallet, store, auction, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const bidder = wallet.publicKey;
  ...
  const getRedeemPrintingV2BidTransactions = ({ bidder, destination, store, vault, auction, auctionManager, auctionExtended, bidRedemption, bidderMeta: bidMetadata, safetyDepositTokenStore, safetyDeposit, safetyDepositConfig, metadata, newMint, newMetadata, newEdition, masterEdition, editionMarker: editionMark, prizeTrackingTicket, winIndex, editionOffset, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const txBatch = new TransactionsBatch({ transactions: [] });
  ...
  const redeemParticipationBidV3 = ({ connection, wallet, store, auction, }) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const claimBid = ({ connection, wallet, store, auction, bidderPotToken, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const bidder = wallet.publicKey;
      const auctionManager = yield mplMetaplex$2.AuctionManager.getPDA(auction);
      const manager = yield mplMetaplex$2.AuctionManager.load(connection, auctionManager);
      const vault = new require$$1.PublicKey(manager.data.vault);
  ...
  const getClaimBidTransactions = ({ bidder, auctionTokenMint, store, vault, auction, auctionManager, auctionExtended, acceptPayment, bidderPot, bidderPotToken, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const txBatch = new TransactionsBatch({ transactions: [] });
  ...
  const instantSale = ({ connection, wallet, store, auction, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const txIds = [];
      const auctionManagerPDA = yield mplMetaplex$2.AuctionManager.getPDA(auction);
      const manager = yield mplMetaplex$2.AuctionManager.load(connection, auctionManagerPDA);
      const vault = yield mplTokenVault$2.Vault.load(connection, manager.data.vault);
  ...
  const burnToken = ({ connection, wallet, token, mint, amount, owner, close = true, }) => __awaiter$c(void 0, void 0, void 0, function* () {
  ...
  const sendToken = ({ connection, wallet, source, destination, mint, amount, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const txs = [];
  ...
  const closeVault = ({ connection, wallet, vault, priceMint, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const accountRent = yield connection.getMinimumBalanceForRentExemption(require$$1$1.AccountLayout.span);
  ...
  const createExternalPriceAccount = ({ connection, wallet, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const txBatch = new TransactionsBatch({ transactions: [] });
      const txOptions = { feePayer: wallet.publicKey };
  ...
  const createVault = ({ connection, wallet, priceMint = require$$1$1.NATIVE_MINT, externalPriceAccount, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const accountRent = yield connection.getMinimumBalanceForRentExemption(require$$1$1.AccountLayout.span);
      const mintRent = yield connection.getMinimumBalanceForRentExemption(require$$1$1.MintLayout.span);
  ...
  const initAuction = ({ connection, wallet, vault, auctionSettings, }) => __awaiter$c(void 0, void 0, void 0, function* () {
      const txOptions = { feePayer: wallet.publicKey };
