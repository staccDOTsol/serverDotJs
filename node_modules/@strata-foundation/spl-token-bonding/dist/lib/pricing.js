...
class BondingPricing {
    ...
    current(baseMint = this.hierarchy.tokenBonding.baseMint, unixTime) {
        return reduce({
    ...
    sellTargetAmount(targetAmountNum, baseMint = this.hierarchy.tokenBonding.baseMint, unixTime) {
        return reduce({
            hierarchy: this.hierarchy,
            func: (acc, current) => {
    ...
    buyTargetAmount(targetAmountNum, baseMint = this.hierarchy.tokenBonding.baseMint, unixTime) {
        return reduce({
            hierarchy: this.hierarchy,
            func: (acc, current) => {
    ...
    buyWithBaseAmount(baseAmountNum, baseMint = this.hierarchy.tokenBonding.baseMint, unixTime) {
