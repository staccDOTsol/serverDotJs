...
export declare class SplTokenBonding extends AnchorSdk<SplTokenBondingIDL> {
    ...
    static init(provider: Provider, splTokenBondingProgramId?: PublicKey): Promise<SplTokenBonding>;
     ...
     * @param param0
     */
    swap({ payer, sourceAuthority, baseMint, targetMint, baseAmount, expectedBaseAmount, desiredTargetAmount, expectedOutputAmount, slippage, balanceCheckTries, extraInstructions, }: ISwapArgs): Promise<{
        targetAmount: number;
    }>;
     ...
     * @returns
     */
    transferReservesInstructions({ tokenBonding, destination, amount, reserveAuthority, payer, }: ITransferReservesArgs): Promise<InstructionResult<null>>;
    /**
     * Runs {@link closeInstructions}
     * @param args
     */
