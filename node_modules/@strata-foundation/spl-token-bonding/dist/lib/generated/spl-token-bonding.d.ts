...
export declare const SplTokenBondingIDLJson: Idl & {
    metadata?: {
        address: string;
    };
};
export declare type SplTokenBondingIDL = {
    "version": "3.2.5";
...
export declare type PrimitiveCurve = Record<string, Record<string, any>>;
export declare const PrimitiveCurve: {
    ExponentialCurveV0: {
        exponentialcurvev0: {};
    };
...
export declare type PiecewiseCurve = Record<string, Record<string, any>>;
export declare const PiecewiseCurve: {
    TimeV0: {
        timev0: {};
    };
};
export declare type ProgramStateV0 = IdlAccounts<SplTokenBondingIDL>["programStateV0"];
export declare type CurveV0 = IdlAccounts<SplTokenBondingIDL>["curveV0"];
export declare type TokenBondingV0 = IdlAccounts<SplTokenBondingIDL>["tokenBondingV0"];
//# sourceMappingURL=spl-token-bonding.d.ts.map