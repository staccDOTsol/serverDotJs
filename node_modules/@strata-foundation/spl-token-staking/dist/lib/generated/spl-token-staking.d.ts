...
export declare const SplTokenStakingIDLJson: Idl & {
    metadata?: {
        address: string;
    };
};
export declare type SplTokenStakingIDL = {
    "version": "0.4.1";
...
export declare type PeriodUnit = Record<string, Record<string, any>>;
...
export declare type TokenStakingV0 = IdlAccounts<SplTokenStakingIDL>["tokenStakingV0"];
export declare type StakingInfoV0 = IdlAccounts<SplTokenStakingIDL>["stakingInfoV0"];
export declare type StakingVoucherV0 = IdlAccounts<SplTokenStakingIDL>["stakingVoucherV0"];
//# sourceMappingURL=spl-token-staking.d.ts.map