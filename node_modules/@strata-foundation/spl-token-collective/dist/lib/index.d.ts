...
declare type CollectiveConfigV0 = IdlTypes<SplTokenCollectiveIDL>["CollectiveConfigV0"];
/**
...
export declare class SplTokenCollective extends AnchorSdk<SplTokenCollectiveIDL> {
    ...
    static init(provider: Provider, splCollectiveProgramId?: PublicKey, splTokenBondingProgramId?: PublicKey): Promise<SplTokenCollective>;
    constructor(opts: {
        provider: Provider;
