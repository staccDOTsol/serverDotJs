...
export declare const SplTokenCollectiveIDLJson: Idl & {
    metadata?: {
        address: string;
    };
};
export declare type SplTokenCollectiveIDL = {
    "version": "3.2.5";
...
export declare type CollectiveV0 = IdlAccounts<SplTokenCollectiveIDL>["collectiveV0"];
export declare type TokenRefV0 = IdlAccounts<SplTokenCollectiveIDL>["tokenRefV0"];
//# sourceMappingURL=spl-token-collective.d.ts.map